...
console.log(`The weight of tyrannosaurus is ${tyrannosaurus.weight}`);

// What was the diet of a velociraptor?
console.log(`The diet of velociraptor is ${velociraptor.diet}`);

// How long was a stegosaurus?
console.log(`The length of stegosaurus is ${stegosaurus.length}`);

// What time period did tyrannosaurus live in?
console.log(
  `The time period when tyrannosaurus lived in is ${tyrannosaurus.period}`
);

// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.
console.log(`Here is how the tyrannosaurus roars!! -> ${tyrannosaurus.roar()}`);

// ==== Arrays ====

// Given an array of college graduates.  Complete the following requests WITHOUT using any array
// methods like .forEach(), .map(), .reduce(), .filter()
...
// Getting the universities into universities array from graduates
...
const uni = [];
for (let i = 0; i < graduates.length; i++) {
  // Checking if the university names has the word "uni" in it.
...
// using forEach() to get the animal name + scientific name
...
// using map() to get the animal names in lower case
...
The zoos are concenred about animals with a lower population count. F
ind out which animals have a population less than 5.

*/

// using filter() to get the animals who have population less than 5
