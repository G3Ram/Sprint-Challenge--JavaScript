...
console.log(request1(getGraduates()))
...
*/
function advancedRequest2(animals) {
  return animals.map(({animal_name: name}) => name.toLowerCase())
}
console.log(advancedRequest2(getZooAnimals())) 
